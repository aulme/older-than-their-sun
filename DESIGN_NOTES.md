...
- Tellings: the war count moves with the tellings (down a quarter with the dials, most of the way back with scapegoats), which wants a look. Named heroes and epochs in the tellings; a remnant's telling as the player's first source; testaments as the text on the relic in the detail layer.
