...
- Tellings: blame rarely moves (7 in ten worlds) and a people rarely finds its own relic; the war count fell a quarter with the dial coupling, which wants a look. Named heroes and epochs in the tellings; a remnant's telling as the player's first source; testaments as the text on the relic in the detail layer.
