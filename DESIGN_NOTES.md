...
**Build order**: beliefs, dials and the appraisal, with contact ported onto them; war object and front, postures and will; parasites as a war mode; expeditions, scouts and the watch; pacts, honour and reputation; the reference batch rerun at each step.
