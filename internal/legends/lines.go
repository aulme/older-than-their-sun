...
var facedLines = map[string]string{
	...
	"upload/overcome":      "The {S} copy themselves out of their bodies and into their machines, and go on there. None of them dies any more.",
	"upload/scarred":       "The {S} learn to lift a mind out of its body, and will not. The flesh is holy to them after.",
	"upload/declined":      "At {T} the {S} go into the machines, into a paradise of their own making.",
