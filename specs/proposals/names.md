...
**Status:** In Progress (2026-09-21). Stage 1 (names-ids) implemented; stage 2 (names-translated) waits on `structured-output` stage 2, as `specs/plan.md` orders it. Adjusts `structured-output.md` (see "Adjustments to structured-output" at the end).
...
**Stage 2: names-translated.** Grounded translations, the inventory, the plague profile.
